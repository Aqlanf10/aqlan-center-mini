...
- **(P0-1) محرّك العمولة الواحد وسريانه الزمني**: تكلفة المختبر المرتبطة بزيارة الفاتورة تُخصم مرّةً واحدة وبعملتها؛ إعداد طبيبٍ متقدّم لا يمسّ غيره؛ وكل تغيير نسبة **مستقبليٌّ** من لحظته بسجلٍّ append-only (`doctor_commission_history`) ويُدوَّن قبل/بعد. التفاصيل والصيغة والبذر وقرارات المالك المعلّقة: `docs/DOCTOR_COMMISSION_ENGINE.md`.
- **(P0-2) مدفوعات الموردين والمختبرات**: لا سداد فوق المتبقي على الفاتورة ولا صرف لمورد/مختبر فوق رصيده (إلا «دفعة مقدمة» من المدير بسبب)؛ الدفع بعملةٍ أخرى بسعر لحظة الدفع محفوظًا لقطةً في السند لا تتغيّر؛ والتصحيح قيدٌ معاكس في وردية اليوم. المرجع: `docs/SUPPLIER_PAYMENTS.md`.
