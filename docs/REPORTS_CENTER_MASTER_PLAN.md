...
## R3 — Power Reporting — التالي

- حفظ تقرير مخصص باسم المستخدم.
- Favorites.
- حفظ الفلاتر.
- حفظ الأعمدة وترتيبها.
- Sort / Group By.
- روابط داخلية قابلة للمشاركة مع الفلاتر.
- Duplicate / Rename / Delete saved views.
- Admin templates لتقارير المركز الشائعة.
