-- (P2-5 + P2-9) Opening-balance history (append-only) and money CHECK constraints.
-- Body must remain byte-for-byte equal to FINANCE_CONTROLS_SQL after these comments.
CREATE TABLE IF NOT EXISTS patient_opening_balance_history (
