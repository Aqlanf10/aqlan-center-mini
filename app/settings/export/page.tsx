  ...
  return (
    <main className="mx-auto max-w-3xl p-4 pb-24">
      ...
      <section className="mb-5 rounded-2xl border-2 border-navy-800 bg-white p-4" aria-label="نسخة كاملة">
        ...
        {/*
          * النسخة الموحّدة بملفٍّ واحد (من مستودع الوكيل الآخر): القاعدة والأشعة
          * معًا في tar.gz واحد، والمفتاح (manifest.json) يُكتب أخيرًا — فالتنزيل
          * المقطوع لا يستطيع أن يتنكّر كنسخةٍ كاملة. ومن نسي الأرشيف الثاني
          * ظلّ أصلًا ينقصه — هنا لا ينقصه شيء.
          */}
        <div className="mt-3 rounded-xl border-2 border-emerald-600/40 bg-emerald-50/60 p-3">
          <p className="text-xs font-extrabold text-emerald-900">
            نسخة واحدة تُعِيد كل شيء — البيانات والأشعة معًا
          </p>
          <p className="mt-1 mb-2 text-[11px] leading-5 text-slate-600">
            ملف مضغوط واحد (tar.gz) يحمل قاعدة البيانات وكل أشعة المرضى ومستنداتهم،
            وكل ملف يُتحقَّق منه بالبصمة قبل إدراجه. و«مفتاح» الملف يُكتب آخرًا — فلو
            انقطع التنزيل في المنتصف عرفتَ أنّه ناقص قبل أن تبني عليه سلامةً. هذا
            هو الملف الذي تُستعاد به العيادة كاملةً من ورقةٍ واحدة.
          </p>
          <a href="/api/backup/full"
            className="block rounded-xl bg-emerald-600 py-2 text-center text-xs font-extrabold text-white hover:bg-emerald-700">
            نزّل النسخة الموحّدة (بيانات + أشعّة) بملف واحد
          </a>
        </div>
