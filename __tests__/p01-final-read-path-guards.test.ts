...
/**
 * حرّاس مسارات القراءة للتصحيحات المالية النهائية لـ PR #46 — على PGlite؛
 * ونفس الإثباتات على PostgreSQL الحقيقي في
 * __tests__/postgres/p01-final-read-path-guards.test.ts:
 *
