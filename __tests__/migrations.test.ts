...
/* كل اختبارٍ هنا يطبّق سلسلة الهجرات كاملةً على PGlite داخل العملية — ٢٢ هجرة
   اليوم وتزيد مع كل ميزة. مهلة vitest الافتراضية (٥ ثوانٍ) صارت الحدَّ نفسه
   (قيس ٥٫٤–٧ ثوانٍ على جهازٍ هادئ)، فسقط الاختبار بالمهلة لا بتأكيدٍ خاطئ. لا
   تأكيد على الزمن هنا؛ المهلة الصريحة ميزانيةٌ للسلسلة الكاملة لا إخفاءٌ لعطل. */
describe("نظام الهجرات المُرقَّمة", { timeout: 60_000 }, () => {
