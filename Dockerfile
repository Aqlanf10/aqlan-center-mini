...
#
# عقد Node (TD-02): الصورة 22 هنا هي نفسها في CI (setup-node) وفي package.json engines
# و‎`.nvmrc`‏ — يفحص تطابقها الأربعة آليًا __tests__/environment-parity.test.ts.
#
